...
@section('content')
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <form action="{{url('/')}}/admin/add-package" id="store" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-box">
                    ...
                    <form action="#" data-parsley-validate="" novalidate="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="package_credit"   class="form-control" value="{{ old('package_credit') }}">
                        </div>
