...
@section('content')
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <form action="{{ route('our-speaker.update', $speaker->id) }}" id="store" method="post"
                ...
                <div class="card-box">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" required class="form-control" value="{{ $speaker->title }}">
                    </div>
                     <div class="form-group">
                        <label for="emailAddress">Email <span class="validation-error-label">*</span></label>
                        <input type="text" name="email" required class="form-control" value="{{ $speaker->email }}">
                    </div>
                    <div class="form-group">
                        <label for="emailAddress">Phone <span class="validation-error-label">*</span></label>
                        <input type="text" name="phone" required class="form-control" value="{{ $speaker->phone }}">
                    </div>
                    <div class="form-group">
