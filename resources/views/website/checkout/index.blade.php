...
@section('content')
    <main id="main-content">
        ...
        <form action="{{ url('payment-card-details?'.csrf_token()) }}" id="checkoutForm" method="post">
            @csrf;
            @method('put')
                                ...
                                <div class="s_r">
                                    ...
                                    <div class="form">
                                        ...
                                        <div class="grid2">
                                            <div class="g_3">
                                                <div class="txta">
                                                    <div class="t1">Select On-demand Date (On-demand will be available after the live session only) </div>
                                                    <div class="t2">
                                                        <input name="on_demand_date" type="date"
                                                               class="t_box2">
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="cart_totals ">
                            <table cellspacing="0" class="shop_table">
                                ...
                                @foreach($carts as $cart)
                                    ...
                                    $pName=  \App\Models\Program::where('id',$cart->program_id)->first();
                                    ...
                                    <tr class="cart-subtotal">
                                        <td width="80%">{{$product->title}} ({{ $pName['program_name'] }})</td>
                                        <td class="Subtotal">$ {{ $pName['price'] * $cart->qty  }}</td>
                                    </tr>
                                    @php
                                        $total[] = str_replace(',', '', round($pName['price'], 0, PHP_ROUND_HALF_DOWN)) *$cart->qty;
                                    @endphp
                                @endforeach
