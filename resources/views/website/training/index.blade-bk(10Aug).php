        ...
        <div class="product-listing">
            ...
            <div class="container">
                <div class="category">
                   ...
                   <h4 class="cat2">Industry<h4> 
                    @foreach($menus as $menu)
                    <a href="javascript:;" data-url="{{$menu->id}}" class="site-btn ll tt <?php if($_REQUEST['industry']==$menu->id){ echo 'active'; } ?>">{!! strip_tags($menu->name) !!}</a>
                    @endforeach
                    <a href="javascript:;" data-url="" class="site-btn ll tt <?php if($_REQUEST['industry']==''){ echo 'active'; } ?>">All</a>
                </div>
                <div class="type">
                    <h4 class="cat1">Program Type <h4>
