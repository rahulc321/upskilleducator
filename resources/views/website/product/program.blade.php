...
@section('title')
    {!! strip_tags($productName) !!} - Up Skill Educator
@endsection
...
.customcheck input:checked ~ .checkmarkone {
    background-color:linear-gradient(to right, #ff2670 0%, #ff6c36 100%);
...
.loginbox .modal.show .modal-dialog {
    ...
    .purchaselist input[type=checkbox]:first-child {
    }

    .directorone .director-img {
        /* width: 120px; */
        float: left;
        margin-right: 10px;
        overflow: hidden;
...
.col-sm-3 {
    width: 25%;
    border-bottom: 2px dashed #f26a21;
}
</style>
...
<div class="courselist">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="newprogrambox">
                    <div class="row">
                       <!--  <div class="col-md-2">
                            <div class="leftbox">
                                    <h5><span><i class="fa fa-calendar" aria-hidden="true"></i></span> EVENT DATE</h5>
                                    <p>{{ \Carbon\Carbon::parse($product->webinar_date_time)->format('M d, Y') }}</p>
                                    <hr>
                                <h5><span><i class="fa fa-user" aria-hidden="true"></i></span> PRESENTED BY</h5>
                                <p>{{$product->speaker_name}}</p>

                                    <hr>
                                    <h5><span><i class="fa fa-clock-o" aria-hidden="true"></i></span> TIME {{ \Carbon\Carbon::parse($product->webinar_date_time)->format('H:i A') }} EST</h5>
                                                                    <hr>
                                    <h5><span><i class="fa fa-clock-o" aria-hidden="true"></i></span> Duration  {{ $product->duration }} Min</h5>
                            </div>
                        </div> -->
                        ...
                        <div class="col-sm-12 yy">
                            ...
                            <div class="col-sm-3">
                                <div class="leftbox">
                                <h5><span><i class="fa fa-clock-o" aria-hidden="true"></i></span> TIME </h5>
                                <p>{{ \Carbon\Carbon::parse($product->webinar_date_time)->format('H:i A') }} EST</p>
                                </div>
                            ...
                            <div class="col-sm-3">
                                <div class="leftbox">
                                <h5><span><i class="fa fa-clock-o" aria-hidden="true"></i></span> Duration  </h5>
                                 <p>{{ $product->duration }} Min</p>
                                 </div>
                            </div>  
                        </div>

                        <div class="col-md-12">
                            <form method="post" action="{{url('add-cart-new/'.$product->url_name) }}" id="frmAddProgramToCart">
                                <input type="hidden" name="_token" value = "{{csrf_token()}}"/>
                                <div class="rightbox">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="purchaselist" id="polist">
                                                <div class="row">
                                                        <div class="col-sm-12">
                                                        <h4 class="p">Single Attendee Option</h4>
                                                        </div>
                                                           ...
                                                           @if($program->type=="live")
                                                            <div class="col-md-4">
                                                                ...
                                                                <label class="customcheck lableName" title="">
                                                                        <!-- <span class="tooltiptext">{{$product->live}}</span> -->
                                                                    {{$program->program_name}}      
                                                                    <input id="chkpo" type="radio" <?php if($program->program_name =='Digital Download + Transcript'){ echo 'checked'; } ?> data="<?=$program->id?>" class="checkbox" name="checkbox[]" value="{{$program->id}}" onclick="($(this).is(&#39;:checked&#39;)?$(this).closest(&#39;.col-md-4&#39;).find(&#39;#hdnQty&#39;).val($(&#39;#txtMainQty&#39;).val()):$(this).closest(&#39;.col-md-4&#39;).find(&#39;#hdnQty&#39;).val(0))">
                                                                    <span class="checkmarkone"></span>
                                                                    <span style="float:right;"><b> ${{$program->price}}</b></span>
                                                                </label>
                                                            ...
                                                            @endif
                                                             @endforeach 
                                                        <div class="col-sm-12">
                                                        <h4 class="p">Can't Attend The Live Event? Choose On-Demand Option</h4>  
                                                        </div>
                                                        @foreach($programs as $program)

                                                           @if($program->type=="On-Demand")
                                                            <div class="col-md-4 On-Demand">
                                                            ...
                                                            @endif
                                                             @endforeach
                                                             <div class="col-sm-12">
                                                        <h4 class="p" >Want To Join In Group? Choose Group Options.</h4>
                                                        </div>
                                                         @foreach($programs as $program)
                                                           ...
                                                           @if($program->type=="group")
                                                            ...
                                                            @endif
                                                             @endforeach   
                                                              ...
                                                              <div class="col-sm-12">
                                                        <h4 class="p" =>Note: For Enterprise Booking, Write Us On support@upskilleducator.com Or Call Us On +1 888-407-9644</h4>
                                                        </div>
                                    ...
                                    <div class="rightboxone">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="purquanti">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="quaninpu form-group">
                                                                <input type="text" id="txtMainQty" onchange="QtyChanged(this);" name="qty" value="1" class="form-control ValidateNum" autofocus="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-3 pull-right">
                                                <div class="addcartbtn">
                                                    <span class="waves-input-wrapper waves-effect waves-light"><input type="submit" onclick="return OnAddProgramToCart(this)" class="site-btn" value="Add to Cart"></span>
                                                </div>
                                            </div>
...
<!---Course Listing---->
<div class="courselist" style="margin-bottom:30px;padding: 10px 0 0 0;">
     
</div>


<script>
    function AddToPackage(RefID,ProgramID,sender)
    {
        if (confirm('So you really want to avail this program in package')) {
            $.ajax({
                url: "/AvailProgramWithPackage",
                type: 'POST',
                data: JSON.stringify({
                    ReferanceID: RefID,
                    ProgramID: ProgramID,
                ...
                success: function (id) {
                    if (id > 0) {
                        alert('Program Added to your subscription successfully!!!!');
                        $(sender).remove();
                    }
                },
    ...
    function QtyChanged(sender) {
        var qty = $(sender).val();
        $("#polist").find('.col-md-4').each(function (index) {
            if ($(this).find('#chkpo').is(':checked')) {
                $(this).find('#hdnQty').val(qty);
            }
        });
    }
    //$(".purchaselist #hdnQty:first").val(1)
    $("#hdnQty input[type=checkbox]").click(function (e) {
    ...
    $(document).ready(function () {
       ...
       // $(".purchaselist").find("input:checkbox:first").attr('checked', 'checked');
    });
    function OnAddProgramToCart(sender) {
        if ($('input:radio').filter(':checked').length < 1) {
            alert("Select at least one purchase option!");
            return false;
        }
        else {
            return true
