    ...
    <main id="main-content">
        ...
        <div class="our-speakers">
            <div class="container">
                ...
                <div class="speaker-slider owl-carousel test">
                    @foreach($speakers as $speaker)
                        <div class="item">
                            <div class="image"
                                 style="background-image: url({{ $speaker->image }});"></div>
                            <h3>{{ $speaker->title }}</h3>
                            <p>{!! substr($speaker->description, 0, 300) !!}...<a href="{{url('/speaker-detail')}}/{{$speaker->title}}">More</a></p>
                        </div>
                    @endforeach
                </div>
            </div>
