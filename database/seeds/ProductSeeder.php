    ...
    public function run()
    {
        $products = array(
            array(
                ...
                'category_id' => 1,
                'type' => 1,
                'url_name' => 'improve-your-conflict-resolution-skills-the-proven-process-for-managing-conflict-in-the-workplace',
                'title' => 'Improve Your Conflict-Resolution Skills: The Proven Process for Managing Conflict in the Workplace',
                'speaker_name' => 'Matthew Burr',
                'speaker_picture' => 'products/speaker/speaker-circle.png',
                'picture' => 'products/product-list-img.jpg',
                'price' => 99.00,
                'webinar_date_time' => \Carbon\Carbon::now()->addMonth(1),
                'duration' => '60',
                'overview' => '<h3>Avoiding Common Errors in Form I-9 Compliance, Storage, Destruction, Making Corrections,
                ...
                'speaker' => '<h3>Avoiding Common Errors in Form I-9 Compliance, Storage, Destruction, Making Corrections,
                                and Review of Documents</h3>
                            <p>The Form I-9 is frequently referred to as "the most complicated two page form in
                                America." The Form I-9 has 15 pages of instructions and a 69-page handbook that provides
                                details on how to properly complete the Form I-9. In addition, there is an entire body
                ...
                'ceus' => '<h3>Avoiding Common Errors in Form I-9 Compliance, Storage, Destruction, Making Corrections,
                                and Review of Documents</h3>
                            <p>The Form I-9 is frequently referred to as "the most complicated two page form in
                                America." The Form I-9 has 15 pages of instructions and a 69-page handbook that provides
                                details on how to properly complete the Form I-9. In addition, there is an entire body
