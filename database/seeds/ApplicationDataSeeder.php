...
class ApplicationDataSeeder extends Seeder
{
    ...
    public function run()
    {
        $description = '<h3><b>Avoiding Common Errors in Form I-9 Compliance, Storage, Destruction, Making Corrections,
                                and Review of Documents</b></h3>
                            ...
                            <h3><b>Why You Should Attend</b></h3>
                            <ul>
        ...
        for ($i = 1; $i <= 6; $i++) {
            $appdata = new \App\Models\ApplicationData();
            $appdata->type = $i;
